...
CLIENT_LIBRARY_FIELDS = {
    "checkbox": ['Audience_Definer_Complete', 'Brand_Builder_Complete', 'Content_Collector_Complete', 'Content_Rewriter_Complete', 'Gap_Analyzer_Complete', 'Guidelines_Finalizer_Complete', 'Voice_Auditor_Complete', 'Voice_Traits_Builder_Complete', 'Brand_Builder_Complete # TO BE ADDED', 'Content_Collector_Complete # TO BE ADDED', 'Voice_Auditor_Complete # TO BE ADDED', 'Audience_Definer_Complete # TO BE ADDED', 'Voice_Traits_Builder_Complete # TO BE ADDED', 'Gap_Analyzer_Complete # TO BE ADDED', 'Content_Rewriter_Complete # TO BE ADDED', 'Guidelines_Finalizer_Complete # TO BE ADDED'],
    "email": ['Contact_Email'],
    "last_edited_time": ['Last_Updated'],
    "multi_select": ['Brand_Personality', 'Desired_Emotional_Impact', 'Desired_Emotional_Impact # TO BE ADDED', 'Brand_Personality # TO BE ADDED'],
    "phone_number": ['Phone_Number'],
    "relation": ['Content_Samples', 'Project_Tracker', 'Voice_Guidelines'],
    "rich_text": ['Brand_Mission', 'Brand_Values', 'Company_Description', 'Deep_Research_Workflow', 'Facebook_URL', 'Ideal_Target_Audience', 'Instagram_URL', 'Last_Tool_Completed', 'LinkedIn_URL', 'Location', 'Other_Social_Media', 'Product_Service_Description', 'Target_Audience', 'Twitter_URL', 'Value_Proposition', 'Product_Service_Description # TO BE ADDED', 'LinkedIn_URL # TO BE ADDED', 'Twitter_URL # TO BE ADDED', 'Facebook_URL # TO BE ADDED', 'Instagram_URL # TO BE ADDED', 'Other_Social_Media # TO BE ADDED', 'Deep_Research_Workflow # TO BE ADDED', 'Last_Tool_Completed # TO BE ADDED'],
    "rollup": ['Content_Count', 'Last_Project_Update', 'Progress_Average', 'Project_Count', 'Voice_Status'],
    "select": ['Communication_Tone', 'Company_Size', 'Industry', 'Research_Status', 'Research_Status # TO BE ADDED'],
    "title": ['Name'],
    "url": ['Website'],
}
...
CONTENT_SAMPLES_FIELDS = {
    "checkbox": ['Original_Sample', 'Rewritten_Version', 'Original_Sample # TO BE ADDED', 'Rewritten_Version # TO BE ADDED'],
